/* THIS FILE IS GENERATED.  -*- buffer-read-only: t -*- vi:set ro:
  Original: intelgt-arf11.xml */

#include "gdbsupport/tdesc.h"

static int
create_feature_intelgt_arf11 (struct target_desc *result, long regnum)
{
  struct tdesc_feature *feature;

  feature = tdesc_create_feature (result, "org.gnu.gdb.intelgt.arf11");
