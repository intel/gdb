...
typedef lanes_mask_t (gdbarch_active_lanes_mask_ftype) (struct gdbarch *gdbarch, thread_info *tp);
...
typedef CORE_ADDR (gdbarch_push_dummy_code_ftype) (struct gdbarch *gdbarch, CORE_ADDR sp, CORE_ADDR funaddr, struct value **args, int nargs, struct type *value_type, CORE_ADDR *real_pc, CORE_ADDR *bp_addr, struct regcache *regcache, dummy_frame_dtor_ftype **arch_dummy_dtor, void **arch_dtor_data);
extern CORE_ADDR gdbarch_push_dummy_code (struct gdbarch *gdbarch, CORE_ADDR sp, CORE_ADDR funaddr, struct value **args, int nargs, struct type *value_type, CORE_ADDR *real_pc, CORE_ADDR *bp_addr, struct regcache *regcache, dummy_frame_dtor_ftype **arch_dummy_dtor, void **arch_dtor_data);
...
typedef std::array<uint64_t, 3> (gdbarch_current_workitem_global_id_ftype) (struct gdbarch *gdbarch, thread_info *tp);
extern std::array<uint64_t, 3> gdbarch_current_workitem_global_id (struct gdbarch *gdbarch, thread_info *tp);
...
typedef std::array<uint64_t, 3> (gdbarch_workitem_global_size_ftype) (struct gdbarch *gdbarch, thread_info *tp);
extern std::array<uint64_t, 3> gdbarch_workitem_global_size (struct gdbarch *gdbarch, thread_info *tp);
...
extern bool gdbarch_kernel_instance_id_p (struct gdbarch *gdbarch);

typedef value * (gdbarch_kernel_instance_id_ftype) (struct gdbarch *gdbarch, thread_info *tp);
extern value * gdbarch_kernel_instance_id (struct gdbarch *gdbarch, thread_info *tp);
extern void set_gdbarch_kernel_instance_id (struct gdbarch *gdbarch, gdbarch_kernel_instance_id_ftype *kernel_instance_id);
...
typedef bool (gdbarch_top_addr_empty_shadow_stack_ftype) (const CORE_ADDR addr, const std::pair<CORE_ADDR, CORE_ADDR> range);
