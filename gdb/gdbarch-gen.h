...
typedef unsigned int (gdbarch_active_lanes_mask_ftype) (struct gdbarch *gdbarch, thread_info *tp, frame_info_ptr frame);
extern unsigned int gdbarch_active_lanes_mask (struct gdbarch *gdbarch, thread_info *tp, frame_info_ptr frame);
...
extern bool gdbarch_address_space_from_type_flags_p (struct gdbarch *gdbarch);

typedef unsigned int (gdbarch_address_space_from_type_flags_ftype) (struct gdbarch *gdbarch, type_instance_flags type_flags);
extern unsigned int gdbarch_address_space_from_type_flags (struct gdbarch *gdbarch, type_instance_flags type_flags);
