...
typedef const unsigned int (gdbarch_address_space_from_type_flags_ftype) (struct gdbarch *gdbarch, type_instance_flags type_flags);
extern const unsigned int gdbarch_address_space_from_type_flags (struct gdbarch *gdbarch, type_instance_flags type_flags);
