...
extern mi_cmd_argv_ftype mi_cmd_thread_execution_mask;
extern mi_cmd_argv_ftype mi_cmd_thread_filter;
extern mi_cmd_argv_ftype mi_cmd_thread_hit_lanes_mask;
extern mi_cmd_argv_ftype mi_cmd_thread_info;
extern mi_cmd_argv_ftype mi_cmd_thread_list_ids;
extern mi_cmd_argv_ftype mi_cmd_thread_select;
extern mi_cmd_argv_ftype mi_cmd_thread_simd_width;
...
struct mi_command
{
  ...
  std::optional<scoped_restore_tmpl<bool>> do_suppress_notification () const;
