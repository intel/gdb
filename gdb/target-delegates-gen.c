...
{
  target_debug_printf_nofunc ("-> %s->ack_library (...)", this->beneath ()->shortname ());
  this->beneath ()->ack_library (arg0);
  target_debug_printf_nofunc ("<- %s->ack_library (%s)",
	      this->beneath ()->shortname (),
	      target_debug_print_const_char_p (arg0).c_str ());
}
...
{
  target_debug_printf_nofunc ("-> %s->ack_in_memory_library (...)", this->beneath ()->shortname ());
  this->beneath ()->ack_in_memory_library (arg0, arg1);
  target_debug_printf_nofunc ("<- %s->ack_in_memory_library (%s, %s)",
	      this->beneath ()->shortname (),
	      target_debug_print_CORE_ADDR (arg0).c_str (),
	      target_debug_print_CORE_ADDR (arg1).c_str ());
}
