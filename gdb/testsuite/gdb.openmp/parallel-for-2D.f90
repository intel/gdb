...
program parallel_for_2D
  ...
  integer, dimension(0:DIM_0, 0:DIM_1) :: in_arr
  integer, dimension(0:DIM_1, 0:DIM_0) :: out_arr
  ...
  !$omp distribute parallel do collapse(2) private(in_elem, in_elem2, in_elem3)
  do i = 0, DIM_0 - 1
    do j = 0, DIM_1 - 1
