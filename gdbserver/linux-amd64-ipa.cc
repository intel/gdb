...
static uint64_t idx2mask[X86_TDESC_LAST] = {
  ...
  X86_XSTATE_SSE_MASK,
  X86_XSTATE_AVX_MASK,
  X86_XSTATE_AVX_APX_MASK,
  X86_XSTATE_AVX_AVX512_MASK,
  X86_XSTATE_AVX_AVX512_APX_MASK,
  X86_XSTATE_AVX_AVX512_PKU_MASK,
  X86_XSTATE_AVX_AVX512_PKU_APX_MASK,
  X86_XSTATE_AVX_AVX512_PKU_AMX_MASK,
  X86_XSTATE_AVX_AVX512_PKU_AMX_APX_MASK
};
#endif
