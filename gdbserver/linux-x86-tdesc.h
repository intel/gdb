...
enum x86_linux_tdesc {
  ...
  X86_TDESC_AVX = 2,
  X86_TDESC_AVX_APX = 3,
  X86_TDESC_AVX_AVX512 = 4,
  X86_TDESC_AVX_AVX512_APX = 5,
  X86_TDESC_AVX_AVX512_PKU = 6,
  X86_TDESC_AVX_AVX512_PKU_APX = 7,
  X86_TDESC_AVX_AVX512_PKU_AMX = 8,
  X86_TDESC_AVX_AVX512_PKU_AMX_APX = 9,
  X86_TDESC_LAST = 10,
};
